...
<p>Given an integer array <code>nums</code>âââ, return <em>the <strong>minimum</strong> number of elements to remove to make </em><code>nums<em>âââ</em></code><em> </em><em>a <strong>mountain array</strong>.</em></p>
